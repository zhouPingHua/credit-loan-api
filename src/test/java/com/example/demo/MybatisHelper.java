 ...
 *
 *  copy from http://git.oschina.net/free/Mapper/blob/master/src/test/java/tk/mybatis/mapper/mapper/MybatisHelper.java
 */
public class MybatisHelper {
    ...
    static {
        try {
            //创建SqlSessionFactory
            Reader reader = Resources.getResourceAsReader("OracleConfiguration_test.xml");
